...
static yam_str resolve_plain(const yam_schema *schema, const char *val) {
    return yam_schema_resolve(schema, (yam_str){val, strlen(val)},
                              YAM_SCALAR_PLAIN);
}
...
static void test_failsafe(void) {
    ...
    const yam_schema *s = yam_schema_failsafe();
...
static void test_json(void) {
    printf("test_json:\n");
    const yam_schema *s = yam_schema_json();
...
static void test_core(void) {
    printf("test_core:\n");
    const yam_schema *s = yam_schema_core();
...
static void test_builder(void) {
    ...
    const yam_schema *s = yam_schema_builder_finish(b);
